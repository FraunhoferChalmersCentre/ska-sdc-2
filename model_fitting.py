...
from pipeline.segmentation.metrics import IncrementalCombo, IncrementalDice, IncrementalAverageMetric
...
validator = SimpleValidator(base_segmenter, surrogates)
